...
run_settings = myScenario.datasheets(name="helloworldCondaPy_RunControl")
...
# Load raster input
raster_map = myScenario.datasheet_rasters(datasheet="helloworldCondaPy_InputDatasheet",
                                         column="InterceptRasterFile")
raster_values = raster_map.values()

# Set up empty pandas DataFrame to accept output values
my_output_dataframe = myScenario.datasheets(name="helloworldCondaPy_IntermediateDatasheet",
                                            empty=True)
...
myScenario.save_datasheet(name="helloworldCondaPy_IntermediateDatasheet",
